...
class Register_Bike(models.Model):
    ...
    id_user = models.ForeignKey('profiles.Profile', on_delete=models.DO_NOTHING)
    id_bike = models.ForeignKey(Bike, on_delete=models.DO_NOTHING)

    id_point_get = models.ForeignKey('stations.Point', on_delete=models.DO_NOTHING, related_name='id_point_get')

    data_get = models.DateField(auto_now_add=True, auto_now=False)

    id_point_return = models.ForeignKey('stations.Point',  on_delete=models.DO_NOTHING, null=True, related_name='id_point_return')
