          ...
          <Box sx={style}>
            <CardMedia
              ...
              image={
                station.img
                  ? station.img
                  : 'https://imagenesparaperfildewasap.com/wp-content/uploads/no-hay-foto-3.png'
              }
            ...
            <Typography sx={{ mt: 2 }}>
              Total Points: {station.points.length}
            </Typography>
            <Typography sx={{ mt: 2 }}>
              Total Points Unactive: {totalPointsUnactive(station.points)}
            </Typography>
            <Typography sx={{ mt: 2 }}>
              Total Bikes: {totalPointsBike(station.points)}
            </Typography>
            <Typography sx={{ mt: 2 }}>
              Total Bikes Unactive: {totalPointsBikeUnactive(station.points)}
            </Typography>
          </Box>
        </Modal>
      </div>
