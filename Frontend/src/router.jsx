...
export default function MyRouter() {
  ...
  const AdminStation = React.lazy(() =>
    import('./pages/Admin/AdminStation/AdminStation')
  );
  const FormStation = React.lazy(() =>
    import('./pages/Admin/FormStation/FormStation')
  );

  const AdminBike = React.lazy(() =>
    import('./pages/Admin/AdminBike/AdminBike')
  );
  const AdminPoint = React.lazy(() =>
    import('./pages/Admin/AdminPoint/AdminPoint')
  );
